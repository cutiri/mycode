...
class GameInitializer:
    def __init__(self) -> None:
        ...
        self.bunker = room.Room("Bunker", "A bunker with huge hole on the side probably made by a Zerg's Guardian", [], [hydralisk])
        ...
        refinery.addGate(gate.Gate("south", self.bunker, [keycard], []))
